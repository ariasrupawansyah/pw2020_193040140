...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2020 at 07:08 PM
...
(3, 'c.jpg', 'Coat', 'Jas wol yang berpanel lengan panjang berwarna hitam dan bernama Black Gamel Coat. Konstruksi yang asimetris. Kerah kerah yang berlekuk. Penutupan kancing di depan. Saku yang di patch logo dan dapat dilepas di dada', 'ADER error (Black gamel)', 'S, M', 2000000),
...
(17, 'k.jpg', 'Jacket', 'Jaket dengan nama Assasins hoodie, di desain untuk penggemar assasin creed. berwarna merah tua, dan juga putih. Lambang perlawanan terhadap templar, dan bersembunyi dalam keramaian', 'AC (Assasins hoodie)', 'M, L, XL', 900000);
