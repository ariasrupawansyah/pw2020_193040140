...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2020 at 04:20 PM
...
(3, 'c.jpg', 'Coat', 'Jas wol yang berpanel lengan panjang berwarna hitam dan bernama Black Gamel Coat. Konstruksi yang asimetris. Kerah kerah yang berlekuk. Penutupan kancing di depan. Saku yang di patch logo dan dapat dilepas di dada', 'ADER error (Black gamel)', 'S', 2000000),
...
(17, 'k.jpg', 'Jacket', 'Jaket dengan nama Assasins hoodie, di desain untuk penggemar assasin creed. berwarna merah tua, dan juga putih. Lambang perlawanan terhadap templar, dan bersembunyi dalam keramaian', 'AC (Assasins hoodies)', 'S, M, L, XL', 900000);
...
(2, 'aria', '$2y$10$XLFFDJqXYyKZn.HN4wsEuOufjMoOGYw3mK2Ninb5MD2aGcylWfDge'),
(3, 'amon', '$2y$10$wiDfsokx9cqoWCLvRrQ33OrZB/1zY.NTNoTeAN6CaUjBWCdVzKbsC'),
(4, 'arai', '$2y$10$/uOnMvN88kLHoZSSbgTEW.bKszwEY5tljP41s/IfEdRgYeDFf44/m'),
(5, 'admin', '$2y$10$0IieoK7jzF/ItCgcIbdHYOQVunod61DIqhqvyKgXgjxxSLEJy2z9O'),
(7, 'mammon', '$2y$10$uNx4zRYpIAY4gE9NPnUgTu9MUoDEeiLjqaigVlSAeDgwrch.EDApu'),
(8, 'test', '$2y$10$VmKwlkiQ8hLECM3DStqBEOYUXB0iivTPJwzUKslIVr5vtMzpdoeHO');
